...
@push('scripts')
    <script>
        $(document).ready(function() {
            ...
            // Gestion de la suppression d'une destination
            $('.delete-destination').on('click', function() {
                ...
                Swal.fire({
                    title: 'Êtes-vous sûr ?',
                    text: `Vous êtes sur le point de supprimer la destination "${destinationVille}". Cette action est irréversible.`,
                    type: "warning",
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            url: `/manager/destinations/${destinationId}`,
                            type: 'DELETE',
                            data: {
                                _token: '{{ csrf_token() }}'
                            },
                            success: function(response) {
                                if (response.success) {
                                    Swal.fire({
                                        title: 'Supprimé !',
                                        text: response.message || 'La destination a été supprimée avec succès.',
                                        type: 'success',
