                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class="row">
                                    ...
                                    <div class="col-12 mb-4">
                                        <div class="form-group">
                                            <label for="attractions" class="form-label fw-bold">Attractions locales</label>
                                            <textarea class="form-control @error('attractions') is-invalid @enderror" 
                                                      id="attractions" name="attractions" rows="3" 
                                                      placeholder="Listez les attractions locales (facultatif)...">{{ old('attractions') }}</textarea>
                                            @error('attractions')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
