                        ...
                        <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control @error('ville') is-invalid @enderror" 
                                                       id="ville" name="ville" value="{{ old('ville', $destination->ville) }}" 
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control @error('code_aeroport') is-invalid @enderror" 
                                                       id="code_aeroport" name="code_aeroport" value="{{ old('code_aeroport', $destination->code_aeroport) }}" 
                                            ...
                                            <div class="input-group">
                                                ...
                                                <select class="form-select select2 @error('timezone') is-invalid @enderror" 
                                                    ...
                                                    @foreach($timezones as $tz)
                                                        <option value="{{ $tz }}" {{ old('timezone', $destination->timezone) == $tz ? 'selected' : '' }}>
                                                            {{ $tz }}
                                                        </option>
                                                    @endforeach
                                                </select>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group mb-4">
                                    <label for="image" class="form-label fw-bold">Image de la destination</label>
                                    <input type="file" class="dropify" id="image" name="image" 
                                           data-allowed-file-extensions="jpg jpeg png"
                                           data-max-file-size="2M"
                                           data-height="200"
                                           data-default-file="{{ $destination->getImageUrlComplete() }}" />
                                    @error('image')
                                        <div class="text-danger small mt-1">{{ $message }}</div>
                                    @enderror
                                    <small class="text-muted d-block mt-2">
                                        Format accepté : JPG, JPEG, PNG. Taille max : 2MB. Laissez vide pour conserver l'image actuelle.
                                    </small>
                                </div>
                                <!-- Statut -->
                                <div class="form-group mb-4">
